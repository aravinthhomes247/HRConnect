...
<div class="career ms-4">
    ...
    <div class="cantabs me-0 mt-2 pt-2 pb-2">
        <div class="tabs ms-1 me-1">
            <a href="#" class="tab " id="date-btn-today">Today</a>
            <a href="#" class="tab " id="date-btn-yesterday">Yesterday</a>
            <a href="#" class="tab " id="date-btn-lsdays">Last 7 days</a>
            <a href="#" class="tab " id="date-btn-ltdays">Last 30 days</a>
        </div>
    </div>
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('/data-candidate/load/today_activity') ?>",
                "type": "GET",
                "data": function(d) {
            ...
            "initComplete": function() {
                ...
                this.api().columns(4).every(function() {
                    var column = this;
                    var select = $('<select class="Search  SelectedFiltervalue-3" ><option value=""> Assign To</option></select>');
                    var select_w = $('<div class="select-wrapper"></div>')
                        .append(select)
                        .append('<i class="fa fa-filter filter-icon dataTF-icon" aria-hidden="true"></i>')
                        .appendTo($(column.header()).empty());
    ...
    function url_change() {
        window.history.replaceState(null, '', 'todays_activity?fs=' + $('#filter_status').val() + '&fd=' + $('#filter_designation').val() + '&hr=' + $('#filter_hr').val() + '&fsd=' + $('#filter_s_date').val() + '&fed=' + $('#filter_e_date').val());
    }
