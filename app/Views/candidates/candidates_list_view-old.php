...
<style>
    ...
    /* select.Search .SelectedFiltervalue-1{
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                    ...
                                    <div class="d-flex justify-content ">
                                        <?php if ($trickid != 11 && $trickid != 9) { ?>
                                            ...
                                            <div class="form-group ml-1">
                                                <a href="#" class=" btn btn-sm bg-orange  mt-1" data-toggle="modal" data-target="#assignModalCenter">Assign <span class="badge badge-light"><?= $yetToAssignCount[0]['Count'] ?></span></a>
                                            </div>
                                            <div class="form-group ml-1">
                                                <a href="#" class=" btn btn-sm bg-orange  mt-1" data-toggle="modal" data-target="#reassignModalCenter">Re Assign <span class="badge badge-light"></span></a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <?php if ($trickid != 11 && $trickid != 9) { ?>
                                        <a href="#" class="btn btn-sm bg-orange mt-1 disabled" id="trackid-12" data-trackid="12">Untouched <span class="badge badge-light" id="Tit-count-12"></span></a>
                    ...
                    <div class="modal-content">
                        <form action="<?= site_url('/assignCandidates') ?>" method="post" autocomplete="off">
                            ...
                            <div class="modal-body row">
                                ...
                                <di class="form-group col-lg-4">
                                    <label for="assignCount">Assign Count</label>
                                    <select class="form-control" id="assignSource" name="assignCount" Required>
                                        <option value="">--Select--</option>
                            ...
                            <div class="form-group col-lg">
                                <table class="table table-hover table-modal" id="example1111">
                                    <thead>
                                        <tr>
                                            <th>Sl no</th>
                                            <th>Name</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="<?= site_url('/reassignCandidates') ?>" method="post" autocomplete="off">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Re Assign </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body row">
                            ...
                            <div class="form-group col-lg">
                                <label for="assignCount">Assign Count</label>
                                <input type="text" class="form-control" id="reassignCount" name="assignCount" placeholder="Count" Required>
                            </div>
                            <div class="form-group col-lg">
                            ...
                            <div class="form-group col-lg">
                                <table class="table table-hover table-modal" id="example111">
                                    <thead>
                                        <tr>
                                            <th>Sl no</th>
                                            <th>Name</th>
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        if ((trickid == 1) || (trickid == 9) || (trickid == 10) || (trickid == 11)) {
            ...
            var table111 = $('.modal #example111').DataTable({
                "paging": true,
                "info": true,
                "searching": false,
                "responsive": true,
                ...
                "drawCallback": function(settings) {
                    if (table111.data().count() === 0) {
                        $('#example111 thead').hide();
                    } else {
                        $('#example111 thead').show();
                    }
                },
            });
        ...
        var table1111 = $('.modal #example1111').DataTable({
            "paging": true,
            "info": true,
            "searching": false,
            "responsive": true,
            ...
            "drawCallback": function(settings) {
                if (table1111.data().count() === 0) {
                    $('#example1111 thead').hide();
                } else {
                    $('#example1111 thead').show();
                }
            },
        });
    ...
    function assignfrom() {
        ...
        HRList.forEach(element => {
            if (element.EmployeeName === assignhr) {
                ...
                // $('#assignfrom').val(element.EmployeeId);
            }
        });
    }
    ...
    function source() {
        ...
        socialMedia.forEach(element => {
            if (element.SM_Name === assignsource) {
                ...
                // $('#assignSource').val(element.SM_IDPK);
            }
        });
    }
