...
<input type="hidden" id="trickid" value="<?= $trickid ?>">
...
<script type='text/javascript'>
    ...
    function url_change() {
        window.history.replaceState(null, '', 'HRmy_overdues?trickid=' + $('#trickid').val() + '&fs=' + $('#filter_source').val() + '&fd=' + $('#filter_designation').val() + '&hr=' + $('#filter_hr').val() + '&fsd-1=' + $('#filter_s_date_1').val() + '&fed-1=' + $('#filter_e_date_1').val() + '&fsd-2=' + $('#filter_s_date_2').val() + '&fed-2=' + $('#filter_e_date_2').val() + '&res=' + $('#filter_reason').val());

        $('#trackid-12').attr('href', "<?= site_url('/HRmy_overdues?trickid=12') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-8').attr('href', "<?= site_url('/HRmy_overdues?trickid=8') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-6').attr('href', "<?= site_url('/HRmy_overdues?trickid=6') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-5').attr('href', "<?= site_url('/HRmy_overdues?trickid=5') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-4').attr('href', "<?= site_url('/HRmy_overdues?trickid=4') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-3').attr('href', "<?= site_url('/HRmy_overdues?trickid=3') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-2').attr('href', "<?= site_url('/HRmy_overdues?trickid=2') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
        $('#trackid-1').attr('href', "<?= site_url('/HRmy_overdues?trickid=1') ?>" + "&fs=" + $('#filter_source').val() + "&fd=" + $('#filter_designation').val() + "&hr=" + $('#filter_hr').val() + "&fsd-1=" + $('#filter_s_date_1').val() + "&fed-1=" + $('#filter_e_date_1').val() + "&fsd-2=" + $('#filter_s_date_2').val() + "&fed-2=" + $('#filter_e_date_2').val());
    }
