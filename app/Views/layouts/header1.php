  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar main-sidebar-custom sidebar-light-primary elevation-4">
      ...
      <a href="<?php echo base_url('/dashboard') ?>" class="brand-link">
        <!-- <img src="<?php //echo base_url('../favicon.png')
                        ?>" alt="Homes247.in" class="brand-image img-circle elevation-3"style="opacity: .8;width: 40px; margin-top: 10px;" > -->
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($session->get('user_level') == 1) { ?>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('/candidate?&fdate=' . $fdate . '&todate=' . $todate . '&trickid=13') ?>" class="nav-link">
