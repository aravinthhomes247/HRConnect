            ...
            <div class="col-12">
                <div class="card mt-2">
                    <div class="card-header">
                        <h3 class="card-title"> Late Coming Data</h3>
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table id="example" class="table table-striped table-bordered example examp1 table-hover " style="width:100%">                            
                            <thead>
                                <tr>
                                    <th>Sl No</th>
                                    <th>EmployeeCode</th>
                            ...
                            <tbody>
                                <?php $i=1; if($empLatecomer): ?>
                                <?php foreach($empLatecomer as $row): ?>
                                <tr>                         
                                    <td><?php echo $i++; ?></td>
...
<script>
    ...
    function datefilter()
    {
        ...
        window.location.href = 'latecomingHistory?&fdate='+fromdateid+'&todate='+todateid+'&empid='+empid;
...
function datefilter()
{
    ...
    window.location.href = 'reportemp?&fdate='+fromdateid+'&todate='+todateid;
