            ...
            <div class="col-12">
                <div class="card mt-2">
                    <div class="card-header">
                        <h3 class="card-title">Employees Attendance Data</h3>
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table id="example" class="table table-striped table-bordered example examp1 table-hover " style="width:100%">
                            ...
                            <tbody>
                                <?php $i=1; if($attendanceList): ?>
                                    <?php foreach($attendanceList as $row): ?>
                                    <tr>
                                        
                                        <td><?= $i++; ?></td>
                                        <td><?= $row['UserId']; ?><input type="hidden" id="UserId" value="<?= $row['UserId']; ?>" ></td>
                                        <td><?= $row['name']; ?></td>                                        
                                        <td><?= $row['login']; ?></td>
                                        <td><?= $row['logout']; ?></td>
...
function datefilter()
{
    ...
    window.location.href = 'attendanceReport?&fdate='+fromdateid+'&todate='+todateid;
