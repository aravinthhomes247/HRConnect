      ...
      <div class="container-fluid">
        ...
        <div class="col-12 col-lg-5">
            ...
            <div class="card mt-2">
             ...
             <!-- .'/'.$showAbsentEmpDetails[0]['EmployeeId'].'/'.$showAbsentEmpDetails[0]['AbsentDate'] -->
              <form action="<?= site_url('/add_reason') ?>" method="post"  autocomplete="off" enctype="multipart/form-data">
