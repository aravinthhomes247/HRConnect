        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <p class="float-left"><?php if( $emp_obj['Status']=='Working') { echo 'Active';}elseif( $emp_obj['Status']=='InActive'){echo'InActive';}else{echo'Abscond';} ?></p>
                <a class="float-right" href="<?php echo base_url('editProfile-view/'.$emp_obj['EmployeeId']);?> " title="Edit"><h2 style="font-size: 20px;"><i class="ion ion-edit "></i></h2></a>
              ...
              <div class="card-footer">
                ...
                <div class="row">
                  <div class="col-sm-12 p-0">
                    ...
                    <a href="<?php $date=date("Y-m-d"); echo base_url('leaveHistory/'.$emp_obj['EmployeeId'].'/'.$date);?>" class="btn btn-sm bg-orange mt-1"><b>Leave history</b></a>
                  ...
                  <div class="tab-pane" id="employement">
                    <table class="table ">                      
                      <tbody>        
                        ...
                        <tr>
                            <td><b>Status</b></td>
                            <td><?php if( $emp_obj['Status']=='Working') { echo 'Active';}elseif( $emp_obj['Status']=='InActive'){echo'InActive';}else{echo'Abscond';} ?></td>
                        </tr>
                        <tr>
                    ...
                    <table class="table ">                      
                      <tbody>        
                        <tr>
                            ...
                            <td><?php if(!empty($empBank)){ echo $empBank['AccountHolderName']; }?>
                            </td>
                            
                        </tr>                        
                        <tr>
                            <td><b>Bank Name</b></td>
                            <td><?php if(!empty($empBank)){ echo $empBank['BankName']; }?></td>                            
                        </tr>                        
                        <tr>
                            <td><b>Account No</b></td>
                            <td><?php if(!empty($empBank)){ echo $empBank['AccountNo']; }?></td>                            
                        </tr>                        
                        <tr>
                            <td><b>IFSCode</b></td>
                            <td><?php if(!empty($empBank)){ echo $empBank['IFSCode']; }?></td>                            
                        </tr>                        
                        <tr>
                            <td><b>Bank Branch</b></td>
                            <td><?php if(!empty($empBank)){ echo $empBank['BankBranch']; }?></td>                            
                        </tr>                        
