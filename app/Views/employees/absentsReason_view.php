        ...
        <div class="col-12 col-lg-5 ">
            ...
            <div class="card mt-2 ">
              <div class="card-header text-left">
                <h3 class="card-title">Add Leave Reason </h3>
                
              </div>
             
              <!-- /.card-header -->
              <form action="<?= site_url('/add_reason') ?>" method="post"   enctype="multipart/form-data">
               
                
                <input type="text" name="EmployeeId" class="form-control"  value="<?php echo $showAbsentEmpDetails[0]['EmployeeId']; ?>" >
          ...
          <div class="col-12 col-lg-7 ">
            ...
            <div class="card mt-2">
              <div class="card-header">
                <h3 class="card-title"><?php echo $showAbsentEmpDetails[0]['EmployeeName']; ?> Leaves Taken</h3>
