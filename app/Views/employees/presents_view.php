...
<div class="Employees ms-4 mt-3">
    <div class="row ms-0 me-0 mt-3 pt-2">
        <div class="col col-lg-8">
            ...
            <a href="<?= site_url('/presents?fdate=' . $fdate . '&todate=' . $todate) ?>" class="btn active">Presentees - <?= $presents ?></a>
            <a href="<?= site_url('/absents?trickid=1&LRID=0&fdate=' . $fdate . '&todate=' . $todate) ?>" class="btn">Absentees - <?= $absent ?></a>
            <a href="<?= site_url('/absents?trickid=2&LRID=0&fdate=' . $fdate . '&todate=' . $todate) ?>" class="btn">Updated Absentees - <?= $countFilter[0]['updeated'] ?></a>
        </div>
    ...
    <div class="row ms-1 me-1 mt-3 pt-2">
        <table class="table table-hover ms-2" id="examp1">
            ...
            <tbody>
                <?php 
                    $i=1; 
                    if($presentsdetailslog):
                        foreach($presentsdetailslog as $row): ?>
                        <tr>                         
                            <td><?= $i++; ?></td>
                            <td><?= $row['name']; ?></td>
                            <td><?= $row['UserId']; ?></td>
